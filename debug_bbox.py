...
from src.data.layoutlm_datasets import XFUNDDatasetLoader


def main():
    print("Loading configuration...")
    with open("configs/layoutlmv3_xfund.yaml", "r") as fp:
        config = yaml.safe_load(fp)

    dataset_loader = XFUNDDatasetLoader(config)

    print("Loading dataset...")
    train_dataset, _, _ = dataset_loader.load_data()
