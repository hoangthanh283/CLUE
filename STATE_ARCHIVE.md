...
Superseded/completed session history moved out of STATE.md (2026-07-04) to keep the
live ledger lean. All facts here are DONE or FALSIFIED — kept for provenance (commit
hashes, run paths, verdicts). Nothing here is active work. Current state: see STATE.md.
...
## Active Work (2026-06-25) — LCA baseline (ICLR 2026) IMPLEMENTED + queued to run
...
## Fixed (13 bugs/issues, all committed+pushed)
